...
<head>
    ...
    <script type="text/javascript">
        if (window.innerWidth <= 992) {
            document.location = "{{ route('mob-segreta') }}";
            window.location.replace('{{ route("mob-segreta") }}');
        }
...
<div class="container">
    ...
    <div class="d-flex justify-content-center" style="margin-top: 6rem;">
        <a class="com-btn mt-3" href='{{route('segreta-dashboard')}}'>Begin</a>
    </div>
    
</div>

{{-- <div class="">
    <div class="title">SEGRETA</div>
    <div class="title-2">THE BIGGEST ONLINE CRYPT HUNT</div>
    <div class="button"></div>
    <a class="button-text" href="{{ url('auth/google') }}">Begin</a>
</div> --}}
