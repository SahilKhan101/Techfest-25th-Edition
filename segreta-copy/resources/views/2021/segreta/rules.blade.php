...
<div class="container" style="margin-top: 10rem;">
    <p class="heading text-center" >Rules</p>
    
    <p class="sub-title">DISCORD:</p>
    <p class="rule-content" >Rules for discussion on the forum are on the discord channel</p>
    <br style="line-height: 16px;">
    <p class="sub-title">FORMAT:</p>
    <li class="rule-content">To check your current rank, click on leaderboard to find out.</li>
    <li class="rule-content">The date and time of the hunt will be announced soon.</li>
    <br style="line-height: 16px;">
    <p class="sub-title">GENERAL:</p>
    <li class="rule-content">You will be directed to the next question when you type the correct answer to the current question.</li>
    <li class="rule-content">Each question has the same weightage and if two people have answered the same number of questions then time will be used as the differentiating factor</li>
</div>
