...
<head>
    ...
    <script type="text/javascript">
        if (window.innerWidth <= 992) {
            document.location = "{{ route('mob-segreta-rules') }}";
            window.location.replace('{{ route("mob-segreta-rules") }}');
        }
...
<nav>
    @include('2021.segreta.layout.unsign-nav')
...
<div class="container" style="margin-top: 10rem;">
    ...
    <section id="contacts">
        <div class="container">
            ...
            <div style="min-height: 40vh;margin-top: 4vw;" class="container-our">

                <div style="width: 90%; margin-top: 50px;margin-bottom: 10%;" class="contact-tf ">
                    <div style="width: 95%;margin: auto;" class="row ">
                        <div style="" class="col-md-4 mt-4">
                            <div class="row justify-content-center text-white">
                                <p style="text-align: left" >Pratham Kurkure</p>
                            </div>
                            <div style=" margin-top: -7px;" class="row justify-content-center">
                                <p style="text-align: left" ><a class="text-white" href="mailto:prathamkurkure@gmail.com">prathamkurkure@gmail.com</a></p>
                            </div>
                            <div style=" margin-top: -7px;" class="row justify-content-center">
                                <a class="text-white" href="tel:+918788393250"><p >+91 878 839 3250</p></a>
                            </div>
                        </div>
                        <div style="" class="col-md-4 mt-4 ">
                            <div style="text-align: left;" class="row justify-content-center text-white">
                                <p style="text-align: left !important;;"><a class="text-white" href=""></a>Abhinav Ghunawat</p>
                            </div>
                            <div style="text-align: left; margin-top: -7px;" class="row justify-content-center">
                                <p><a class="text-white" href="mailto:ghunawatabhinav34@gmail.com">ghunawatabhinav34@gmail.com</a></p>
                            </div>
                            <div style="text-align: left; margin-top: -7px;" class="row justify-content-center">
                                <a class="text-white" href="tel:+919653815924"><p >+91 965 381 5924</p></a>
                            </div>
                        </div>
                        <div style="" class="col-md-4 mt-4 ">
                            <div style="text-align: left;" class="row justify-content-center text-white">
                                <p style="text-align: left !important;;"><a class="text-white" href=""></a>Rounak Dalmia</p>
                            </div>
                            <div style="text-align: left; margin-top: -7px;" class="row justify-content-center">
                                <p><a class="text-white" href="mailto:rounakdalmia123@gmail.com">rounakdalmia123@gmail.com</a></p>
                            </div>
                            <div style="text-align: left; margin-top: -7px;" class="row justify-content-center">
                                <a class="text-white" href="tel:+919660658865"><p >+91 966 065 8865</p></a>
                            </div>
                        </div>
                    </div>
                </div>
