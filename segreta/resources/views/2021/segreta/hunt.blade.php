...
<div class="container" style="margin-top: 15rem;">
    <div class="row ">
        <div class="col-md-5 d-flex align-items-center" data-aos="fade-right ">
            <img class="img" style="margin-top:0vh; width: 27rem; height: 18rem; border-radius: 10px; padding: 5px;" src="{{asset('2021/segreta/bg.jpg')}}" alt="">
        </div>
        <div class="col-md-7" >
            <div class="abs-class" data-aos="fade-left" style=" top: 0;">
                <h1 class="d-none d-md-block" style="font-weight: 700;">LEVEL 1</h1>
                <hr style="margin-top:9rem; width: 100% !important;" >
                <div class="d-flex justify-content-left">
                    <a class="com-btn mt-3" style="width: 9rem; height: 3rem; font-size: 1.3rem; font-weight:400;" href=''>Check</a>
                    <p style="margin-top: 1.5rem; margin-left:2rem; font-size: 1.3rem;" >INCORRECT ANSWER! Try again</p>
                </div>
            </div>
        </div>
    </div>
