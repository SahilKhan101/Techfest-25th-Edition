...
<head>
    ...
    <script type="text/javascript">
        if (window.innerWidth <= 992) {
            document.location = "{{ route('mob-segreta-faqs') }}";
            window.location.replace('{{ route("mob-segreta-faqs") }}');
        }
...
<div class="container" style="margin-top: 10rem; width:60%;">
    <p class="heading text-center" >FAQs</p>
    <div class="justify-content-left">
        <div class="agenda-span">
            <div class="justify-content-left">
                <a class="com-btn2" href="#">How many hints will we get in each question?</a>
            </div>
        </div>
        <div class="agenda-span">
            <div class="justify-content-left">
