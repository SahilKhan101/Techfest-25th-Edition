...
<div class="container" style="margin-top: 10rem;">
    <p class="text-center" style="font-size: 3vw; font-weight: 1000;" >Leaderboard</p>
    
    <div class="">
        <div class="row label justify-content-center" style="margin-bottom: 1.5vw">
            <div class="col-4 row justify-content-left">Rank</div>
            <div class="col-4 row justify-content-center">Name</div>
            <div class="col-4 row justify-content-end">Level</div>
        </div>
        <div class="com-btn3">
            <div class="row leader-content justify-content-center">
                <div class="col-4 row justify-content-left">4</div>
                <div class="col-4 row justify-content-center">Yash Sharma</div>
                <div class="col-4 row justify-content-end">10</div>
            </div>
        </div>
        <div class="com-btn3">
            <div class="row leader-content justify-content-center">
